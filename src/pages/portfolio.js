  ...
  return (
    <>
      <div className="container">
        ...
        <div className="bees">
          <a
            href="https://savethebeesgoreli.netlify.app/"
            rel="noreferrer"
            target="_blank"
          >
            <img src={bees} alt="" />
          ...
          <div className="icons">
            <a
              href="https://github.com/Tebbo-Web-Devs/beesdapp"
              rel="noreferrer"
              target="_blank"
            >
              <ImGithub />
        ...
        <div className="pots">
          <a
            href="https://potty-pots.vercel.app/"
            rel="noreferrer"
            target="_blank"
          >
            <img src={pots} alt="" />
          ...
          <div className="icons">
            <a
              href="https://github.com/leetebbs/potty-pots"
              rel="noreferrer"
              target="_blank"
            >
              <ImGithub />
        ...
        <div className="badcr">
          ...
          <div className="text">
            A React.js site deployed to the polygon network using the ERC721A
            smart contract. Using canvas, css and react.
          </div>
          <div className="icons">
            <a
              href="https://github.com/leetebbs/BADCR"
              rel="noreferrer"
              target="_blank"
            >
              <ImGithub />
        ...
        <div className="shortr">
          <a
            href="https://shortr-zeta.vercel.app/"
            rel="noreferrer"
            target="_blank"
          >
            <img src={shortr} alt="" />
          ...
          <div className="icons">
            <a
              href="https://github.com/leetebbs/shortr"
              rel="noreferrer"
              target="_blank"
            >
              <ImGithub />
